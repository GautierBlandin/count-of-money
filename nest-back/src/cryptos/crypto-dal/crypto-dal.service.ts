...
import {CryptoCurrency} from "./cryptos.entity";
import {CreateCryptoCurrencyRequest, DeleteCryptoCurrencyRequest, GetCryptoCurrencyRequest} from "./cryptos.interface";
...
export class CryptoDalService {
    ...
    constructor(@InjectRepository(CryptoCurrency) private repository: Repository<CryptoCurrency>) {}
