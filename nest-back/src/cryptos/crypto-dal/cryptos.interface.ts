 ...
 */
export interface UpdateCryptoCurrencyRequest extends Omit<Partial<CryptoCurrencyInterface>, 'uuid'>
{
    uuid: string
}
 ...
 */
export interface DeleteCryptoCurrencyRequest extends Partial<Pick<CryptoCurrencyInterface, 'uuid' | 'name' | 'symbol'>> {}
