...
export class migrationNameHere1639599729589 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "user" ADD "currency" character varying NOT NULL DEFAULT 'EUR'`);
        await queryRunner.query(`ALTER TABLE "user" ADD "cryptos" text NOT NULL`);
        await queryRunner.query(`ALTER TABLE "user" ADD "press_keywords" text NOT NULL`);
        await queryRunner.query(`ALTER TABLE "user" DROP CONSTRAINT "PK_76b415448b9145997d0016b7195"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "user" ADD CONSTRAINT "PK_76b415448b9145997d0016b7195" PRIMARY KEY ("uuid", "email")`);
